...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(220, 20, 211, 51))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(20, 140, 101, 41))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.txt_info_text.setGeometry(QtCore.QRect(140, 150, 561, 151))
        self.txt_info_text.setObjectName("txt_info_text")
        self.txt_sign = QtWidgets.QTextBrowser(self.centralwidget)
        self.txt_sign.setGeometry(QtCore.QRect(140, 330, 561, 131))
        self.txt_sign.setObjectName("txt_sign")
        self.btn_sign = QtWidgets.QPushButton(self.centralwidget)
        self.btn_sign.setGeometry(QtCore.QRect(190, 480, 93, 28))
        self.btn_sign.setObjectName("btn_sign")
        self.btn_verify = QtWidgets.QPushButton(self.centralwidget)
        self.btn_verify.setGeometry(QtCore.QRect(530, 480, 93, 28))
